...
{
    public class MunicipioCrudCompleto : BaseTest, IClassFixture<DataBaseTest>
    {

        private ServiceProvider _serviceProvide;

        public MunicipioCrudCompleto(DataBaseTest dbTeste)
        {
        ...
        public async Task E_Possivel_Realizar_CRUD_Municipio()
        {
            using (var context = _serviceProvide.GetService<MyContext>())
            {
                ...
                MunicipioRepository _repositorio = new MunicipioRepository(context);
